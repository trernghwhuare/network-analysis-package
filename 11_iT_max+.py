...
from neuroml import (Population,Location,Instance,IncludeType,Cell,NeuroMLDocument,
                     ...
                     InputW,InputList,PulseGenerator,AlphaSynapse,ExpTwoSynapse,DoubleSynapse,
                     ...
                     Property,InputList,PulseGenerator,AlphaSynapse,ExpTwoSynapse,
...
nml_doc = component_factory("NeuroMLDocument",id="iT_max_plus")
net = nml_doc.add("Network", id="iT_max_plus", type="networkWithTemperature",validate=False)
...
def create_population_instances_parallel():
    ...
    all_populations = TCs_matrix + TCs_core + TCs_intralaminar
...
def validate_populations(created_populations):
    ...
    for pop_list in [TCs_matrix + TCs_core + TCs_intralaminar]:
        for pop in pop_list:
...
def calculate_connection_statistics():
    ...
    inh_cells = inh_cells_TCs_core | inh_cells_TCs_intralaminar
        ...
        for j, (pre_cellID, pre_size, pre_axonalNum,
            ...
            try:
                ...
                for _ in range(n_connections):
                    ...
                    if is_thalamic_cell(post_popID):
                        # Cortical cells: avoid segment ID 1, allow segment 0 with 10% probability
                        if random.random() < 0.1:
