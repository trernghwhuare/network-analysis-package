...
def generate_sample_plots():
    ...
    conn_ratio_results = conn_ratio.analyze_connection_ratios(json_files, plots_dir="output_plots")
    ...
    analysis.plot_connection_type_violins(df, outpath="output_plots/sample_violins.png")
    analysis.plot_clustered_heatmap(df, outpath="output_plots/sample_clustermap.png")
    analysis.plot_combined_heatmaps(df, outpath="output_plots/sample_combined_heatmaps.png")
    analysis.plot_ei_scatter_with_stacked(df, outpath="output_plots/sample_ei_stacked.png")
    
    print("Sample plots generated successfully!")
    print("Check the 'output_plots' directory for the generated plots.")
